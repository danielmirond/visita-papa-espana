...
const L: Record<Locale, Translation> = {
  es: {
    ...
    intro: 'Esta página recopila testimonios reales y enlaces verificables —Vatican.va, canal oficial de la JMJ, prensa católica española— de peregrinos que vivieron las cinco grandes visitas papales a España desde 1982. Son historias de jóvenes bajo la tormenta de Cuatro Vientos, de gallegos en el Monte do Gozo, de catalanes en la dedicación de la Sagrada Familia, de madrileños en la canonización de los cinco españoles. Sirven de inspiración a los peregrinos que se preparan para la visita del Papa León XIV (6-12 de junio de 2026) y muestran que lo verdaderamente importante no son las cifras de asistencia, sino la huella que cada uno se lleva a casa.',
    events: [
      {
        year: '2011',
  ...
  it: {
    ...
    intro: 'Questa pagina raccoglie testimonianze reali e link verificabili —Vatican.va, canale ufficiale della GMG, stampa cattolica spagnola— di pellegrini che vissero le cinque grandi visite papali in Spagna dal 1982. Sono storie di giovani sotto la tempesta di Cuatro Vientos, di galiziani al Monte do Gozo, di catalani alla dedicazione della Sagrada Familia, di madrileni alla canonizzazione dei cinque spagnoli. Servono d’ispirazione ai pellegrini che si preparano per la visita di Papa Leone XIV (6-12 giugno 2026) e mostrano che ciò che davvero conta non sono le cifre di partecipazione, ma l’impronta che ciascuno porta a casa.',
    events: [
