...
const L: Record<Locale, Translation> = {
  ...
  fr: {
    ...
    intro: 'Cette page rassemble des témoignages réels de pèlerins qui ont vécu les cinq grandes visites papales en Espagne depuis 1982. Chaque témoignage renvoie à sa source d’origine (Vatican.va, la chaîne officielle des JMJ, la presse catholique espagnole), pour que vous puissiez le vérifier. Il y a des histoires de jeunes surpris par l’orage de Cuatro Vientos, de Galiciens sur le Monte do Gozo, de Catalans à la dédicace de la Sagrada Família, de Madrilènes à la canonisation des cinq saints espagnols. Elles peuvent inspirer les pèlerins qui se préparent maintenant à la visite du Pape Léon XIV (6-12 juin 2026). Et elles rendent quelque chose évident : ce qui compte vraiment, ce n’est pas le nombre de participants, mais la trace que chacun rapporte chez lui.',
    events: [
