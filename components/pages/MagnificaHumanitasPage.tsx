...
const L: Record<Locale, Translation> = {
  es: {
    ...
    intro: '«Magnifica humanitas» es el título de la primera carta encíclica del Papa León XIV, dedicada a «la custodia de la persona humana en el tiempo de la inteligencia artificial». El documento se publicará el 25 de mayo de 2026 y lleva la firma del Pontífice con fecha del 15 de mayo, coincidiendo deliberadamente con el 135º aniversario de la promulgación de Rerum Novarum (1891), la encíclica de León XIII que inauguró la Doctrina Social de la Iglesia. La presentación oficial se celebrará en el Aula del Sínodo, en presencia del Papa, a las 11:30 horas del 25 de mayo. Esta encíclica antecede en 12 días al Viaje Apostólico a España (6-12 de junio de 2026) y previsiblemente marcará el tono del discurso del Papa ante el Congreso de los Diputados el 8 de junio.',
    quickFacts: [
    ...
    whyBody: [
      'Magnifica humanitas es la primera encíclica del pontificado de Robert Francis Prevost, elegido Papa el 8 de mayo de 2025 con el nombre de León XIV. La elección del nombre apuntaba ya a este momento: en su primer discurso al Colegio Cardenalicio, el nuevo Pontífice explicó que tomaba el nombre de Leo en homenaje a León XIII, autor de la Rerum Novarum (1891), pionera de la Doctrina Social de la Iglesia ante la primera revolución industrial.',
      'León XIV plantea ahora una respuesta análoga a la nueva revolución industrial de nuestro tiempo: la inteligencia artificial. La encíclica «Magnifica humanitas» se propone iluminar éticamente el impacto de las tecnologías de IA sobre la dignidad humana, el trabajo, la libertad de conciencia y la justicia social. Es la primera vez que un Pontífice dedica una encíclica completa a la cuestión de la IA, después de mensajes parciales de Francisco al G7 (2024) y referencias en discursos de Benedicto XVI.',
      'La firma el 15 de mayo, coincidiendo con el 135º aniversario exacto de Rerum Novarum, no es casual: vincula simbólicamente ambos documentos como respuestas paralelas a dos revoluciones industriales separadas por 135 años. La continuidad de la doctrina social se hace explícita en el gesto litúrgico-documental.',
    ],
    parallelTitle: 'Rerum Novarum (1891) ⟷ Magnifica humanitas (2026)',
    parallelIntro: 'El paralelismo entre las dos encíclicas, separadas por 135 años, es deliberado. Estructura comparada de sus contextos y respuestas:',
    comparisons: [
      { title: 'Revolución técnica de fondo', old: 'Primera revolución industrial: máquina de vapor, fábrica, urbanización masiva, capitalismo de fábrica.', new: 'Cuarta revolución industrial: inteligencia artificial, automatización cognitiva, plataformas digitales globales.' },
      { title: 'Cuestión central de dignidad', old: 'La condición del obrero industrial: jornadas extensas, salarios injustos, ausencia de derechos colectivos.', new: 'La condición de la persona ante la máquina inteligente: sustitución laboral, vigilancia algorítmica, decisiones automatizadas que afectan derechos.' },
      { title: 'Adversarios doctrinales', old: 'Liberalismo económico extremo y socialismo materialista.', new: 'Determinismo tecnológico y tecnocracia sin control democrático.' },
      { title: 'Propuesta positiva', old: 'Salario justo, derecho de asociación, propiedad como derecho natural, función social del capital.', new: 'Gobernanza internacional de la IA, derecho a la trazabilidad algorítmica, supervisión humana sustantiva, dignidad como criterio último.' },
    ],
    themesTitle: 'Posibles ejes temáticos de la encíclica',
    themesIntro: 'Sobre la base de los discursos previos de León XIV (mensaje al G7 sobre IA en su primer año, discurso al Cuerpo Diplomático, intervención en Davos), la encíclica podría desarrollar cinco grandes líneas:',
    themes: [
      { title: 'Dignidad y singularidad de la persona humana', body: 'La IA no puede reducir a la persona a un patrón estadístico. La encíclica reafirmaría la imagen de Dios como fundamento ontológico de la dignidad, contra cualquier intento reduccionista.' },
      { title: 'Trabajo en la era de la automatización', body: 'Continuidad de Laborem Exercens (1981). Cómo proteger el trabajo digno cuando la IA sustituye tareas cognitivas. Renta básica, formación continua, derecho al trabajo significativo.' },
      { title: 'Verdad, desinformación y libertad de conciencia', body: 'IA generativa, deepfakes, manipulación masiva. La encíclica clamaría por una nueva ética de la verdad pública y por la protección del derecho a no ser manipulado algorítmicamente.' },
      { title: 'Gobernanza internacional de la IA', body: 'Llamada a una autoridad supranacional al estilo de la propuesta de Pacem in terris (1963) de Juan XXIII para el orden mundial. Regulación coordinada que no quede al criterio de unas pocas empresas.' },
      { title: 'Vulnerabilidad y bien común', body: 'Niños, ancianos, migrantes, personas con discapacidad: cómo la IA puede ampliar o reducir su acceso a derechos. Principio de preferencia por los más débiles, conectando con la ecología integral de Laudato si’.' },
    ],
    contextTitle: 'Contexto del pontificado',
    contextBody: 'Desde su elección, León XIV ha situado la IA como prioridad programática. En su primer discurso al Colegio Cardenalicio (mayo 2025) explicitó que la IA era una cuestión análoga a la planteada por Rerum Novarum. Su mensaje al G7 en Roma sobre IA continuó esa línea, denunciando que «ninguna máquina debería decidir quién vive y quién muere». Magnifica humanitas culmina ese año inicial de pontificado y abre el escenario doctrinal del viaje a España, donde León XIV se dirigirá al Congreso de los Diputados (8 jun) y a la sociedad civil en el Movistar Arena (7 jun). Se espera que las claves de la encíclica resuenen en ambos discursos.',
  ...
  en: {
    ...
    intro: '"Magnifica humanitas" is the title of Pope Leo XIV’s first encyclical letter, dedicated to "the care of the human person in the age of artificial intelligence". The document will be published on 25 May 2026 and bears the Pontiff’s signature dated 15 May, deliberately coinciding with the 135th anniversary of the promulgation of Rerum Novarum (1891), Leo XIII’s encyclical that inaugurated the Social Doctrine of the Church. The official presentation will take place at the Synod Hall, in the Pope’s presence, at 11:30 on 25 May. This encyclical precedes the Apostolic Journey to Spain (6-12 June 2026) by 12 days and is expected to set the tone for the Pope’s speech to the Spanish Congress on 8 June.',
    quickFacts: [
    ...
    whyTitle: 'Why it is a historic document',
    whyBody: [
      'Magnifica humanitas is the first encyclical of the pontificate of Robert Francis Prevost, elected Pope on 8 May 2025 with the name Leo XIV. The choice of the name pointed to this very moment: in his first address to the College of Cardinals, the new Pontiff explained that he took the name Leo in homage to Leo XIII, author of Rerum Novarum (1891), pioneering encyclical of the Social Doctrine of the Church in response to the first industrial revolution.',
      'Leo XIV now proposes an analogous response to the new industrial revolution of our time: artificial intelligence. The encyclical "Magnifica humanitas" sets out to ethically illuminate the impact of AI technologies on human dignity, work, freedom of conscience and social justice. It is the first time a Pontiff has dedicated a complete encyclical to the question of AI, after partial messages from Francis to the G7 (2024) and references in speeches by Benedict XVI.',
      'The signing on 15 May, coinciding with the exact 135th anniversary of Rerum Novarum, is not casual: it symbolically links both documents as parallel responses to two industrial revolutions separated by 135 years. The continuity of social doctrine is made explicit in the liturgical-documentary gesture.',
    ],
    parallelTitle: 'Rerum Novarum (1891) ⟷ Magnifica humanitas (2026)',
    parallelIntro: 'The parallelism between the two encyclicals, separated by 135 years, is deliberate. Compared structure of their contexts and responses:',
    comparisons: [
      { title: 'Underlying technical revolution', old: 'First industrial revolution: steam engine, factory, mass urbanisation, factory capitalism.', new: 'Fourth industrial revolution: artificial intelligence, cognitive automation, global digital platforms.' },
      { title: 'Central question of dignity', old: 'The condition of the industrial worker: long hours, unjust wages, absence of collective rights.', new: 'The condition of the person before the intelligent machine: labour substitution, algorithmic surveillance, automated decisions affecting rights.' },
      { title: 'Doctrinal opponents', old: 'Extreme economic liberalism and materialist socialism.', new: 'Technological determinism and technocracy without democratic control.' },
      { title: 'Positive proposal', old: 'Just wage, right of association, property as natural right, social function of capital.', new: 'International AI governance, right to algorithmic traceability, substantive human oversight, dignity as ultimate criterion.' },
    ],
    themesTitle: 'Possible thematic axes of the encyclical',
    themesIntro: 'Based on Leo XIV’s previous speeches (G7 message on AI in his first year, address to the Diplomatic Corps, intervention at Davos), the encyclical could develop five major lines:',
    themes: [
      { title: 'Dignity and singularity of the human person', body: 'AI cannot reduce the person to a statistical pattern. The encyclical would reaffirm the image of God as ontological foundation of dignity, against any reductionist attempt.' },
      { title: 'Work in the age of automation', body: 'Continuity of Laborem Exercens (1981). How to protect dignified work when AI substitutes cognitive tasks. Basic income, continuous training, right to meaningful work.' },
      { title: 'Truth, disinformation and freedom of conscience', body: 'Generative AI, deepfakes, mass manipulation. The encyclical would call for a new ethics of public truth and for the protection of the right not to be algorithmically manipulated.' },
      { title: 'International governance of AI', body: 'Call for a supranational authority along the lines of John XXIII’s proposal in Pacem in terris (1963) for world order. Coordinated regulation not left to the discretion of a few companies.' },
      { title: 'Vulnerability and common good', body: 'Children, elderly, migrants, people with disabilities: how AI can expand or reduce their access to rights. Principle of preference for the weakest, connecting with the integral ecology of Laudato si’.' },
    ],
    contextTitle: 'Pontificate context',
    contextBody: 'Since his election, Leo XIV has placed AI as a programmatic priority. In his first speech to the College of Cardinals (May 2025) he made explicit that AI was a question analogous to that raised by Rerum Novarum. His message to the G7 in Rome on AI continued that line, denouncing that "no machine should decide who lives and who dies". Magnifica humanitas culminates that initial year of pontificate and opens the doctrinal stage for the trip to Spain, where Leo XIV will address the Congress of Deputies (8 Jun) and civil society at the Movistar Arena (7 Jun). The keys of the encyclical are expected to resonate in both speeches.',
    ...
    related: [
      ...
      { href: '/papa-congreso-diputados', text: 'Speech to Congress (8 Jun) — where the encyclical’s theses will be developed' },
