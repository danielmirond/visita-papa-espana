...
const L: Record<Locale, Translation> = {
  ...
  it: {
    ...
    intro: '«Magnifica humanitas» è la prima lettera enciclica di Papa Leone XIV. Affronta come proteggere la persona nell’era dell’intelligenza artificiale. Il testo esce il 25 maggio 2026 e porta la firma del Papa con data 15 maggio, esattamente 135 anni dopo la firma della Rerum Novarum (1891) da parte di Leone XIII, l’enciclica che aprì la Dottrina Sociale della Chiesa. La presentazione ufficiale è lo stesso 25 maggio alle 11:30 nell’Aula del Sinodo, con il Papa presente. Arriva dodici giorni prima del viaggio del Papa in Spagna (6-12 giugno 2026), e molti dei suoi argomenti torneranno nel discorso al Congresso spagnolo di lunedì 8 giugno.',
    quickFacts: [
    ...
    whyTitle: 'Perché è un documento importante',
    whyBody: [
      'È la prima enciclica del pontificato di Robert Francis Prevost, eletto Papa l’8 maggio 2025. Il nome che ha scelto, Leone XIV, puntava già a questo testo: nel suo primo discorso al Collegio Cardinalizio, appena eletto, disse di aver preso quel nome in omaggio a Leone XIII, autore della Rerum Novarum (1891). Quella fu l’enciclica che aprì la Dottrina Sociale della Chiesa come risposta alla prima rivoluzione industriale.',
      'Leone XIV vuole oggi dare una risposta dello stesso peso alla rivoluzione del nostro tempo, l’intelligenza artificiale. L’enciclica affronta l’impatto dell’IA sulla dignità delle persone, sul lavoro, sulla libertà di coscienza e sulla giustizia sociale. Nessun Papa aveva dedicato prima un’enciclica intera a questa questione. Francesco aveva inviato un messaggio al G7 nel 2024 e Benedetto XVI aveva fatto qualche riferimento in alcuni discorsi, ma nulla con questo rango dottrinale.',
      'La firma del 15 maggio cade nell’esatto 135° anniversario della Rerum Novarum. La data è scelta apposta: lega i due documenti come risposte parallele a due rivoluzioni industriali distanti più di un secolo. La continuità della dottrina sociale resta così iscritta nel gesto.',
    ],
    parallelTitle: 'Rerum Novarum (1891) e Magnifica humanitas (2026)',
    parallelIntro: 'Mettere i due testi l’uno di fronte all’altro, a 135 anni di distanza, non è retorica: entrambe le encicliche si confrontano con una rivoluzione industriale usando lo stesso metodo. Ciò che cambia è il contesto:',
    comparisons: [
      { title: 'La rivoluzione di fondo', old: 'La prima rivoluzione industriale: vapore, fabbrica, urbanizzazione di massa, capitalismo industriale.', new: 'La rivoluzione attuale: intelligenza artificiale, automazione del lavoro intellettuale e piattaforme digitali globali.' },
      { title: 'Dove la dignità è ferita', old: 'L’operaio di fabbrica: giornate lunghissime, salari ingiusti, senza diritti collettivi riconosciuti.', new: 'La persona davanti alla macchina che decide: perdita del lavoro, sorveglianza algoritmica, decisioni automatizzate che colpiscono diritti fondamentali.' },
      { title: 'Contro cosa argomenta', old: 'Liberalismo economico estremo e socialismo materialista.', new: 'Determinismo tecnologico e tecnocrazia senza controllo democratico.' },
      { title: 'Cosa propone', old: 'Salario giusto, diritto di associazione, proprietà come diritto naturale, funzione sociale del capitale.', new: 'Governance internazionale dell’IA, diritto a sapere come decide un algoritmo, supervisione umana reale, dignità come limite ultimo.' },
    ],
    themesTitle: 'Di cosa parlerà l’enciclica',
    themesIntro: 'A partire da quello che Leone XIV ha detto in questo primo anno (messaggio al G7 sull’IA, discorso al Corpo Diplomatico, intervento a Davos), l’enciclica girerà probabilmente intorno a cinque questioni:',
    themes: [
      { title: 'La persona, non un dato', body: 'L’IA tende a ridurre la persona a un pattern statistico. L’enciclica ricorda che ciascuno è immagine di Dio, non un profilo utente, e che questa è la linea che non può essere superata.' },
      { title: 'Il lavoro quando la macchina pensa', body: 'Riprende la linea di Laborem Exercens (1981). Come si protegge il lavoro dignitoso quando l’IA fa compiti che prima facevamo noi? Compaiono qui il reddito di base, la formazione lungo tutta la vita e il diritto a un lavoro che abbia senso.' },
      { title: 'Verità, disinformazione e libertà di coscienza', body: 'IA generativa, deepfake, manipolazione su larga scala. L’enciclica chiede una nuova etica della verità pubblica e difende il diritto a non essere manipolati da un algoritmo.' },
      { title: 'Una governance globale dell’IA', body: 'Riprende l’idea che Giovanni XXIII lanciò nella Pacem in terris (1963) su un’autorità sovranazionale. Applicata adesso all’IA: una regolamentazione coordinata tra Stati, non lasciata al criterio di poche aziende.' },
      { title: 'I più vulnerabili', body: 'Bambini, anziani, migranti, persone con disabilità. L’IA può ampliare o tagliare il loro accesso ai diritti. L’enciclica torna al principio dell’opzione preferenziale per i deboli, in sintonia con l’ecologia integrale di Laudato si’.' },
    ],
    contextTitle: 'Dove si colloca nel pontificato',
    contextBody: 'L’IA è stata una priorità chiara per Leone XIV fin dall’inizio. Nel suo primo discorso al Collegio Cardinalizio, nel maggio 2025, aveva già detto che era una questione paragonabile a quella che si trovò davanti la Rerum Novarum. Il messaggio inviato al G7 a Roma sull’IA fu ancora più diretto: «nessuna macchina dovrebbe decidere chi vive e chi muore». Magnifica humanitas chiude quel primo anno di pontificato e apre il terreno dottrinale del viaggio in Spagna. Gli argomenti del testo riappariranno con ogni probabilità nel discorso al Congresso (8 giugno) e nell’incontro con la società civile al Movistar Arena (7 giugno).',
    ...
    related: [
      ...
      { href: '/papa-congreso-diputados', text: 'Discorso al Congresso (8 giu) · dove si svilupperanno gli argomenti dell’enciclica' },
  ...
  fr: {
    ...
    intro: '« Magnifica humanitas » est la première lettre encyclique du Pape Léon XIV. Elle traite de la manière de protéger la personne humaine à l’époque de l’intelligence artificielle. Le texte sort le 25 mai 2026 et porte la signature du Pape datée du 15 mai, exactement 135 ans après la signature de Rerum Novarum (1891) par Léon XIII, l’encyclique qui ouvrit la Doctrine Sociale de l’Église. La présentation officielle a lieu ce même 25 mai à 11h30 dans la Salle du Synode, en présence du Pape. Elle arrive douze jours avant le voyage du Pape en Espagne (6-12 juin 2026), et beaucoup de ses arguments reviendront dans le discours qu’il prononcera au Congrès espagnol le lundi 8 juin.',
    quickFacts: [
    ...
    whyTitle: 'Pourquoi ce document compte',
    whyBody: [
      'C’est la première encyclique de Robert Francis Prevost, élu Pape le 8 mai 2025. Le nom qu’il a choisi, Léon XIV, indiquait déjà ce texte. Aussitôt élu, dans son premier discours au Collège cardinalice, il a dit qu’il prenait ce nom en hommage à Léon XIII. Léon XIII signa Rerum Novarum (1891), l’encyclique qui ouvrit la Doctrine Sociale de l’Église en réponse à la première révolution industrielle.',
      'Léon XIV veut aujourd’hui donner une réponse du même poids à la révolution de notre temps, celle de l’intelligence artificielle. L’encyclique aborde l’impact de l’IA sur la dignité des personnes, sur le travail, sur la liberté de conscience et sur la justice sociale. Aucun Pape n’avait dédié auparavant une encyclique entière à cette question. François avait envoyé un message au G7 en 2024 et Benoît XVI avait fait quelques références dans certains discours, mais rien de ce niveau doctrinal.',
      'La signature du 15 mai tombe exactement au 135e anniversaire de Rerum Novarum. La date est choisie à dessein : elle relie les deux documents comme des réponses parallèles à deux révolutions industrielles séparées de plus d’un siècle. La continuité de la doctrine sociale est ainsi inscrite dans le geste.',
    ],
    parallelTitle: 'Rerum Novarum (1891) et Magnifica humanitas (2026)',
    parallelIntro: 'Mettre les deux textes face à face, à 135 ans d’écart, n’est pas qu’une figure de style : les deux encycliques affrontent une révolution industrielle avec la même méthode. Ce qui change, c’est le contexte :',
    comparisons: [
      { title: 'La révolution de fond', old: 'La première révolution industrielle : vapeur, usine, urbanisation de masse, capitalisme industriel.', new: 'La révolution actuelle : intelligence artificielle, automatisation du travail intellectuel et plateformes numériques mondiales.' },
      { title: 'Où la dignité est blessée', old: 'L’ouvrier d’usine : journées très longues, salaires injustes, sans droits collectifs reconnus.', new: 'La personne face à la machine qui décide : perte d’emploi, surveillance algorithmique, décisions automatisées qui touchent à des droits fondamentaux.' },
      { title: 'Contre quoi elle argumente', old: 'Libéralisme économique extrême et socialisme matérialiste.', new: 'Déterminisme technologique et technocratie sans contrôle démocratique.' },
      { title: 'Ce qu’elle propose', old: 'Salaire juste, droit d’association, propriété comme droit naturel, fonction sociale du capital.', new: 'Gouvernance internationale de l’IA, droit de savoir comment un algorithme décide, vraie supervision humaine, dignité comme limite ultime.' },
    ],
    themesTitle: 'De quoi parlera l’encyclique',
    themesIntro: 'À partir de ce que Léon XIV a dit pendant sa première année (message au G7 sur l’IA, discours au Corps diplomatique, intervention à Davos), l’encyclique tournera probablement autour de cinq questions :',
    themes: [
      { title: 'La personne, pas une donnée', body: 'L’IA a tendance à réduire la personne à un schéma statistique. L’encyclique rappelle que chacun est image de Dieu, pas un profil d’utilisateur, et que c’est la ligne qui ne peut être franchie.' },
      { title: 'Le travail quand la machine pense', body: 'Elle reprend la ligne de Laborem Exercens (1981). Comment protéger un travail digne quand l’IA fait des tâches que nous faisions auparavant ? On y trouve le revenu de base, la formation tout au long de la vie et le droit à un travail qui ait du sens.' },
      { title: 'Vérité, désinformation et liberté de conscience', body: 'IA générative, deepfakes, manipulation à grande échelle. L’encyclique appelle à une nouvelle éthique de la vérité publique et défend le droit à ne pas être manipulé par un algorithme.' },
      { title: 'Une gouvernance mondiale de l’IA', body: 'Elle reprend l’idée que Jean XXIII avait lancée dans Pacem in terris (1963) sur une autorité supranationale. Appliquée maintenant à l’IA : une régulation coordonnée entre États, pas laissée au gré de quelques entreprises.' },
      { title: 'Les plus vulnérables', body: 'Enfants, personnes âgées, migrants, personnes handicapées. L’IA peut élargir ou couper leur accès aux droits. L’encyclique revient au principe de l’option préférentielle pour les plus faibles, dans la ligne de l’écologie intégrale de Laudato si’.' },
    ],
    contextTitle: 'Où ce texte s’inscrit dans le pontificat',
    contextBody: 'L’IA est une priorité claire pour Léon XIV depuis le début. Dans son premier discours au Collège cardinalice, en mai 2025, il avait déjà dit que c’était une question de l’ampleur de celle qu’avait dû affronter Rerum Novarum. Son message au G7 à Rome sur l’IA est allé encore plus loin : « aucune machine ne devrait décider qui vit et qui meurt ». Magnifica humanitas ferme cette première année de pontificat et ouvre le terrain doctrinal du voyage en Espagne. Les arguments du texte reviendront très probablement dans le discours au Congrès (8 juin) et dans la rencontre avec la société civile au Movistar Arena (7 juin).',
    ...
    related: [
      ...
      { href: '/papa-congreso-diputados', text: 'Discours au Congrès (8 juin) · où les arguments de l’encyclique seront développés' },
