...
const L: Record<Locale, Translation> = {
  es: {
    ...
    intro: 'El lunes 8 de junio de 2026, a las 10:30 de la mañana, el Papa León XIV pronunciará un discurso ante el Pleno conjunto del Congreso de los Diputados y el Senado de España. Es la primera vez en la historia que un Pontífice se dirige al Parlamento español, un hito institucional que se enmarca dentro del Viaje Apostólico del Papa a España (6-12 de junio de 2026). Esta página recoge los detalles del acto, el protocolo, los antecedentes con otras visitas papales a parlamentos europeos y las preguntas frecuentes sobre el discurso.',
    quickFacts: [
    ...
    whyHistoricBody: [
      'Ningún Pontífice anterior se había dirigido al Parlamento español en el ejercicio de su ministerio. Juan Pablo II visitó España cinco veces entre 1982 y 2003, pero nunca pronunció un discurso ante el Congreso. Benedicto XVI tampoco intervino en las Cortes durante sus dos viajes (2010 y 2011). Francisco no llegó a visitar España.',
      'León XIV inaugura así una tradición que sí existía en otros países europeos: Juan Pablo II habló en el Bundestag alemán, en la Asamblea Nacional de Polonia y en el Parlamento Europeo. Benedicto XVI lo hizo en Westminster Hall (Reino Unido), en el Bundestag (2011) y en el Parlamento francés. La intervención de León XIV en el Congreso español sitúa por primera vez a las Cortes Generales en esa misma categoría.',
      'El acto se celebra en sesión conjunta del Congreso de los Diputados y el Senado, modalidad reservada constitucionalmente para grandes ocasiones de Estado (jura de los Reyes, declaraciones de guerra, mociones de excepcional gravedad). Es la primera vez que esa modalidad se utiliza para recibir a un jefe de Estado extranjero con dimensión religiosa universal.',
    ],
    contextTitle: 'Contexto político y eclesial',
    contextBody: 'El discurso del Papa León XIV en el Congreso se enmarca en un momento de especial sensibilidad sobre la relación Iglesia-Estado en España, con debates abiertos sobre la financiación eclesiástica, la enseñanza religiosa y los abusos sexuales en el clero. La Santa Sede ha pedido tradicionalmente que estas intervenciones se centren en valores universales —dignidad humana, paz, migración, ecología integral— y eviten posicionamientos partidistas. Los antecedentes de Benedicto XVI en Westminster (2010) y de Francisco en Estrasburgo (2014) son referencia obligada.',
    precedentsTitle: 'Antecedentes · Papas en parlamentos europeos',
    precedents: [
    ...
    themesTitle: 'Posibles temas del discurso',
    themesIntro: 'Sobre la base de las prioridades programáticas anunciadas por León XIV desde el inicio de su pontificado (mayo 2025), el discurso podría abordar cinco grandes ejes:',
    themes: [
      { title: 'Inteligencia artificial y dignidad humana', body: 'Tema central del pontificado y eje de su primera encíclica «Magnifica humanitas» (25 mayo 2026). Llamada a una gobernanza internacional de la IA que respete la persona.' },
      { title: 'Migración como prueba ética del siglo', body: 'Conectado con su visita posterior a Arguineguín (Gran Canaria) y al centro Las Raíces (Tenerife). «Ningún muro es más alto que la dignidad humana».' },
      { title: 'Doctrina social y desigualdad', body: 'Continuidad de Rerum Novarum (135º aniversario en 2026). Precariedad laboral, brecha de rentas, desafíos del trabajo en la era digital.' },
      { title: 'Paz y desarme', body: 'Su «paz desarmada y desarmante» dirigida especialmente a Europa en un contexto de guerra en Ucrania, conflicto en Gaza y rearme generalizado.' },
      { title: 'Ecología integral', body: 'Continuidad de Laudato si’ de Francisco. Vínculo entre justicia climática y justicia social.' },
    ],
    protocolTitle: 'Protocolo del acto',
    protocolBody: 'La sesión está convocada formalmente por las Mesas conjuntas del Congreso y del Senado, presididas por la presidenta del Congreso Francina Armengol y por el presidente del Senado Pedro Rollán. El Papa será recibido en la entrada principal de la Carrera de San Jerónimo por ambos presidentes. El discurso se pronuncia desde el atril central del hemiciclo del Congreso, ampliado al Senado mediante pantallas. La duración prevista es de aproximadamente 50 minutos, sin turno de intervenciones por parte de los grupos parlamentarios. Tras el discurso, breve recepción en el Salón de los Pasos Perdidos.',
    watchTitle: 'Cómo seguir el discurso en directo',
    watchBody: 'La sesión se retransmite en directo por el Canal Parlamento del Congreso, por TVE (La 1 y Canal 24 Horas) y por las plataformas oficiales del Vaticano (Vatican Media YouTube, vaticannews.va). En radio: RNE y COPE con cobertura especial. Las cadenas autonómicas emitirán por la mañana resúmenes y conexiones en directo. Los textos íntegros del discurso se publicarán en vatican.va una vez pronunciados.',
  ...
  en: {
    ...
    intro: 'On Monday 8 June 2026 at 10:30, Pope Leo XIV will address the joint plenary session of the Spanish Congress of Deputies and Senate. It is the first time a Pontiff has spoken to the Spanish Parliament, an institutional milestone within the Apostolic Journey to Spain (6-12 June 2026). This page collects the details of the act, the protocol, the precedents with other papal visits to European parliaments and the frequently asked questions about the speech.',
    quickFacts: [
    ...
    whyHistoricBody: [
      'No previous Pontiff had addressed the Spanish Parliament in the exercise of his ministry. John Paul II visited Spain five times between 1982 and 2003, but never gave a speech to the Congress. Benedict XVI also did not speak to the Cortes during his two trips (2010 and 2011). Francis did not visit Spain.',
      'Leo XIV thus inaugurates a tradition that existed in other European countries: John Paul II spoke at the German Bundestag, the Polish National Assembly and the European Parliament. Benedict XVI spoke at Westminster Hall (United Kingdom), the Bundestag (2011) and the French Parliament. Leo XIV’s intervention at the Spanish Congress places the Cortes Generales for the first time in that same category.',
      'The act is held in a joint session of the Congress of Deputies and the Senate, a modality constitutionally reserved for great state occasions (royal oath, declarations of war, motions of exceptional gravity). It is the first time that this modality has been used to receive a foreign head of state with a universal religious dimension.',
    ],
    contextTitle: 'Political and ecclesial context',
    contextBody: 'Pope Leo XIV’s speech in Congress comes at a moment of particular sensitivity regarding Church-State relations in Spain, with open debates on Church financing, religious education and sexual abuse in the clergy. The Holy See has traditionally asked that these interventions focus on universal values —human dignity, peace, migration, integral ecology— and avoid partisan stances. The precedents of Benedict XVI at Westminster (2010) and Francis at Strasbourg (2014) are mandatory references.',
    precedentsTitle: 'Precedents · Popes at European parliaments',
    precedents: [
    ...
    themesTitle: 'Possible topics of the speech',
    themesIntro: 'Based on the programmatic priorities announced by Leo XIV since the start of his pontificate (May 2025), the speech may address five major axes:',
    themes: [
      { title: 'Artificial intelligence and human dignity', body: 'Central theme of the pontificate and axis of his first encyclical "Magnifica humanitas" (25 May 2026). Call for international AI governance that respects the person.' },
      { title: 'Migration as the ethical test of the century', body: 'Connected with his later visit to Arguineguín (Gran Canaria) and the Las Raíces centre (Tenerife). "No wall is higher than human dignity".' },
      { title: 'Social doctrine and inequality', body: 'Continuity of Rerum Novarum (135th anniversary in 2026). Labour precariousness, income gap, challenges of work in the digital age.' },
      { title: 'Peace and disarmament', body: 'His "unarmed and disarming peace" especially addressed to Europe in a context of war in Ukraine, conflict in Gaza and generalised rearmament.' },
      { title: 'Integral ecology', body: 'Continuity of Francis’s Laudato si’. Link between climate justice and social justice.' },
    ],
    protocolTitle: 'Protocol of the act',
    protocolBody: 'The session is formally convened by the joint Bureaus of the Congress and the Senate, chaired by the President of Congress Francina Armengol and the President of the Senate Pedro Rollán. The Pope will be received at the main entrance of Carrera de San Jerónimo by both presidents. The speech is delivered from the central lectern of the Congress hemicycle, extended to the Senate via screens. The expected duration is about 50 minutes, with no turn of interventions by the parliamentary groups. After the speech, brief reception at the Salón de los Pasos Perdidos.',
    watchTitle: 'How to follow the speech live',
    watchBody: 'The session is broadcast live by the Canal Parlamento of the Congress, by TVE (La 1 and Canal 24 Horas) and by the official Vatican platforms (Vatican Media YouTube, vaticannews.va). Radio: RNE and COPE with special coverage. Regional channels will broadcast summaries and live connections in the morning. The full text of the speech will be published on vatican.va once delivered.',
