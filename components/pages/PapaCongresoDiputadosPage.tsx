...
const L: Record<Locale, Translation> = {
  ...
  it: {
    ...
    intro: 'Lunedì 8 giugno 2026, alle 10:30, Papa Leone XIV parlerà davanti alla seduta plenaria congiunta del Congresso dei Deputati e del Senato spagnolo. Nessun Papa si era mai rivolto prima al Parlamento spagnolo; accadrà ora, dentro il viaggio del Pontefice in Spagna (6-12 giugno 2026). In questa pagina trovi i dettagli dell’evento, il protocollo, cosa hanno fatto altri Papi nei parlamenti europei e le domande più ricorrenti sul discorso.',
    quickFacts: [
    ...
    whyHistoricBody: [
      'Nessun Papa aveva mai parlato prima al Parlamento spagnolo. Giovanni Paolo II visitò la Spagna cinque volte tra il 1982 e il 2003 e non pronunciò mai un discorso al Congresso. Benedetto XVI fece due viaggi (2010 e 2011) e nemmeno lui. Francesco non venne mai in Spagna.',
      'Leone XIV colma così un vuoto che in altri paesi era già stato riempito. Giovanni Paolo II parlò al Bundestag tedesco, all’Assemblea Nazionale polacca e al Parlamento europeo. Benedetto XVI lo fece a Westminster Hall, di nuovo al Bundestag (2011) e al Parlamento francese. Le Cortes Generales si aggiungono ora a quella lista.',
      'La seduta è congiunta di Congresso e Senato. La Costituzione spagnola riserva questa formula a occasioni di Stato molto specifiche, come il giuramento del Re, le dichiarazioni di guerra o le mozioni di gravità eccezionale. È la prima volta che la si usa per ricevere un capo di Stato estero con un ruolo religioso universale.',
    ],
    contextTitle: 'Contesto politico ed ecclesiale',
    contextBody: 'Il discorso arriva in un momento delicato per i rapporti Chiesa-Stato in Spagna. Sono aperti contemporaneamente il dibattito sul finanziamento della Chiesa cattolica, quello sull’insegnamento religioso a scuola e quello sulla gestione degli abusi sessuali nel clero. In discorsi come questo la Santa Sede chiede di solito al Papa di attenersi a valori universali (dignità umana, pace, migrazione, ecologia integrale) e di restare fuori dal terreno partitico. I riferimenti naturali sono Benedetto XVI a Westminster (2010) e Francesco a Strasburgo (2014).',
    precedentsTitle: 'Altri Papi nei parlamenti europei',
    precedents: [
    ...
    themesTitle: 'Di cosa parlerà probabilmente',
    themesIntro: 'A partire da ciò che Leone XIV ha detto in questo primo anno di pontificato, cinque temi compariranno con molta probabilità nel discorso:',
    themes: [
      { title: 'Intelligenza artificiale e dignità della persona', body: 'È il tema centrale del suo pontificato e il cuore della sua prima enciclica, Magnifica humanitas (25 maggio 2026). Chiederà una governance internazionale dell’IA che metta la persona al centro.' },
      { title: 'Migrazione', body: 'Si lega direttamente alle sue visite dei giorni seguenti, ad Arguineguín (Gran Canaria) e al centro Las Raíces (Tenerife). Ha già ripetuto più volte questa frase: «nessun muro è più alto della dignità umana».' },
      { title: 'Dottrina sociale e disuguaglianza', body: 'Continua la linea della Rerum Novarum, che compie 135 anni nel 2026. Parlerà di precarietà lavorativa, divario di reddito e di come il lavoro si stia trasformando con il digitale.' },
      { title: 'Pace e disarmo', body: 'La sua «pace disarmata e disarmante», rivolta soprattutto all’Europa. Lo dirà in un contesto di guerra in Ucraina, conflitto a Gaza e riarmo generalizzato.' },
      { title: 'Ecologia integrale', body: 'Riprenderà la Laudato si’ di Francesco per legare giustizia climatica e giustizia sociale.' },
    ],
    protocolTitle: 'Come funziona l’evento',
    protocolBody: 'A convocare formalmente la seduta sono gli Uffici di Presidenza congiunti di Congresso e Senato, presieduti da Francina Armengol e Pedro Rollán. Entrambi accoglieranno il Papa all’ingresso principale della Carrera de San Jerónimo. Il discorso si pronuncia dal podio centrale dell’aula del Congresso, esteso al Senato tramite schermi. La durata prevista è di circa 50 minuti. Non c’è turno di repliche dei gruppi parlamentari. A seguire, un breve ricevimento al Salón de los Pasos Perdidos.',
    watchTitle: 'Come seguirlo in diretta',
    watchBody: 'La seduta va in diretta sul Canale Parlamento, su TVE (La 1 e Canal 24 Horas) e sulle piattaforme ufficiali del Vaticano (Vatican Media su YouTube, vaticannews.va). In radio si potrà seguire su RNE e sulla COPE, entrambe con copertura speciale. Le emittenti regionali manderanno riassunti e collegamenti in diretta durante la mattina. Il testo integrale del discorso comparirà su vatican.va appena pronunciato.',
  ...
  fr: {
    ...
    intro: 'Le lundi 8 juin 2026, à 10h30, le Pape Léon XIV parlera devant la séance plénière conjointe du Congrès des députés et du Sénat espagnol. Aucun Pape ne s’était adressé auparavant au Parlement espagnol ; cela arrivera maintenant, à l’intérieur du voyage du Pontife en Espagne (6-12 juin 2026). Cette page réunit les détails de l’événement, le protocole, ce que d’autres Papes ont fait dans les parlements européens et les questions que se posent le plus souvent les lecteurs.',
    quickFacts: [
    ...
    whyHistoricBody: [
      'Aucun Pape n’avait parlé auparavant au Parlement espagnol. Jean-Paul II visita l’Espagne cinq fois entre 1982 et 2003 et il ne prononça jamais de discours au Congrès. Benoît XVI fit deux voyages (2010 et 2011) et lui non plus. François n’est jamais venu en Espagne.',
      'Avec ce discours, Léon XIV comble un vide qui était déjà rempli dans d’autres pays. Jean-Paul II parla au Bundestag allemand, à l’Assemblée nationale polonaise et au Parlement européen. Benoît XVI fit la même chose à Westminster Hall, de nouveau au Bundestag (2011) et au Parlement français. Les Cortes Generales espagnoles rejoignent maintenant cette liste.',
      'La séance est conjointe du Congrès et du Sénat. La Constitution espagnole réserve cette formule à des occasions d’État très précises, comme la prestation de serment du Roi, les déclarations de guerre ou les motions d’une gravité exceptionnelle. C’est la première fois qu’on l’utilise pour recevoir un chef d’État étranger ayant un rôle religieux universel.',
    ],
    contextTitle: 'Contexte politique et ecclésial',
    contextBody: 'Le discours arrive à un moment délicat pour les relations Église-État en Espagne. Trois débats sont ouverts en même temps : le financement de l’Église catholique, la place de l’enseignement religieux à l’école et la gestion des abus sexuels dans le clergé. Pour ce type d’intervention, le Saint-Siège demande habituellement au Pape de s’en tenir à des valeurs universelles (dignité humaine, paix, migration, écologie intégrale) et de rester en dehors du terrain partisan. Les références naturelles sont Benoît XVI à Westminster (2010) et François à Strasbourg (2014).',
    precedentsTitle: 'D’autres Papes dans les parlements européens',
    precedents: [
    ...
    themesTitle: 'Ce dont il parlera probablement',
    themesIntro: 'À partir de ce que Léon XIV a dit pendant sa première année comme Pape, cinq thèmes apparaîtront très probablement dans le discours :',
    themes: [
      { title: 'Intelligence artificielle et dignité humaine', body: 'C’est le thème central de son pontificat et le cœur de sa première encyclique, Magnifica humanitas (25 mai 2026). Il appellera à une gouvernance internationale de l’IA qui mette la personne au centre.' },
      { title: 'Migration', body: 'Cela rejoint directement ses visites des jours suivants, à Arguineguín (Grande Canarie) et au centre Las Raíces (Ténérife). Il a déjà répété cette idée : « aucun mur n’est plus haut que la dignité humaine ».' },
      { title: 'Doctrine sociale et inégalité', body: 'Il prolonge la ligne de Rerum Novarum, qui fête ses 135 ans en 2026. Précarité du travail, écart de revenus et transformation du travail à l’ère numérique sont au menu.' },
      { title: 'Paix et désarmement', body: 'Sa « paix désarmée et désarmante », adressée surtout à l’Europe. Il le dira dans un contexte de guerre en Ukraine, de conflit à Gaza et de réarmement généralisé.' },
      { title: 'Écologie intégrale', body: 'Il reprendra la Laudato si’ de François pour relier justice climatique et justice sociale.' },
    ],
    protocolTitle: 'Comment se déroule l’événement',
    protocolBody: 'Ce sont les Bureaux conjoints du Congrès et du Sénat, présidés par Francina Armengol et Pedro Rollán, qui convoquent formellement la séance. Tous deux accueilleront le Pape à l’entrée principale de la Carrera de San Jerónimo. Il parlera depuis le pupitre central de l’hémicycle du Congrès, avec le discours retransmis au Sénat par écrans. La durée prévue est d’environ 50 minutes. Pas de tour de parole des groupes parlementaires. Brève réception ensuite au Salón de los Pasos Perdidos.',
    watchTitle: 'Comment le suivre en direct',
    watchBody: 'La séance passera en direct sur Canal Parlamento, sur TVE (La 1 et Canal 24 Horas) et sur les plateformes officielles du Vatican (Vatican Media sur YouTube, vaticannews.va). Côté radio : RNE et la COPE proposeront une couverture spéciale. Les chaînes régionales espagnoles diffuseront résumés et duplex pendant la matinée. Le texte intégral du discours apparaîtra sur vatican.va dès qu’il aura été prononcé.',
