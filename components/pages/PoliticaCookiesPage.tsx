...
export default function PoliticaCookiesPage({ locale }: Props) {
  return (
    <>
        ...
        <div className="mx-auto max-w-3xl space-y-6 text-papal-navy/85">
          ...
          <section className="rounded-xl bg-papal-cream p-6 text-center">
            <p className="text-sm text-papal-navy/70">
              ...
              <Link href={localizePath('/privacidad', locale)} className="font-bold text-papal-gold-dark hover:underline">
