...
const faqEn: FaqItem[] = [
  ...
  mk('general', 'What time does the Pope arrive in Madrid?', 'Pope Leo XIV lands at Madrid-Barajas Airport on Saturday 6 June 2026 at around 10:30, then heads to the Royal Palace for the welcome ceremony. He arrives in Barcelona on Tuesday 9 June around 12:25 (El Prat Airport), in Gran Canaria on Thursday 11 and in Tenerife on Friday 12. Times may change for security reasons.'),
  mk('general', 'Where does the Pope stay in Madrid and Barcelona?', 'In Madrid the Pope stays at the Apostolic Nunciature (the Holy See’s diplomatic mission in Spain); in Barcelona at the Episcopal Palace in the Gothic Quarter; and in Gran Canaria at the Episcopal Palace of Las Palmas. He does not stay in hotels, for protocol and security reasons.'),
  mk('general', 'How much does the Pope’s visit cost and who pays for it?', 'The visit will cost about 25 million euros. Funding comes 45% from companies, foundations and private benefactors; 30% from the dioceses and the Spanish Bishops’ Conference; 5% from small donations; and 20% from public administrations (mainly security and transport). The estimated economic return exceeds 150 million euros.'),
