...
export const OG_IMAGE_BY_ROUTE: Partial<Record<RouteKey, string>> = {
  ...
  creditos: '/images/hero/papa-leon-xiv.webp',
  'aviso-legal': '/images/hero/papa-leon-xiv.webp',
  privacidad: '/images/hero/papa-leon-xiv.webp',
  'politica-cookies': '/images/hero/papa-leon-xiv.webp',
...
export const seoByRoute: Partial<Record<RouteKey, SeoByLocale>> = {
  ...
  'aviso-legal': {
    es: { title: 'Aviso legal · visita-papa-2026.com', description: 'Aviso legal: titular Daniel Mirón, NIF 44039446N. Política de afiliación y no intermediación turística. Art. 10 LSSI-CE.' },
    en: { title: 'Legal notice · visita-papa-2026.com', description: 'Legal notice: owner Daniel Mirón, NIF 44039446N. Affiliate and non-intermediary policy. Spanish Law LSSI-CE art. 10.' },
    it: { title: 'Note legali · visita-papa-2026.com', description: 'Note legali: titolare Daniel Mirón, NIF 44039446N. Politica di affiliazione e non intermediazione turistica.' },
    fr: { title: 'Mentions légales · visita-papa-2026.com', description: 'Mentions légales : titulaire Daniel Mirón, NIF 44039446N. Politique d\'affiliation et de non-intermédiation.' },
    de: { title: 'Impressum · visita-papa-2026.com', description: 'Impressum: Inhaber Daniel Mirón, NIF 44039446N. Affiliate- und Nichtvermittlungsrichtlinie.' },
    pt: { title: 'Aviso legal · visita-papa-2026.com', description: 'Aviso legal: titular Daniel Mirón, NIF 44039446N. Política de afiliação e não intermediação.' },
    ca: { title: 'Avís legal · visita-papa-2026.com', description: 'Avís legal: titular Daniel Mirón, NIF 44039446N. Política d\'afiliació i no intermediació.' },
    gl: { title: 'Aviso legal · visita-papa-2026.com', description: 'Aviso legal: titular Daniel Mirón, NIF 44039446N. Política de afiliación e non intermediación.' },
    eu: { title: 'Lege-oharra · visita-papa-2026.com', description: 'Lege-oharra: titularra Daniel Mirón, NIF 44039446N. Afiliazio- eta ez-bitartekaritza-politika.' },
  },

  privacidad: {
    es: { title: 'Política de privacidad · visita-papa-2026.com', description: 'Política de privacidad conforme al RGPD y LOPDGDD 3/2018. Responsable, datos, finalidades, derechos ARCO-OLP y contacto.' },
    en: { title: 'Privacy policy · visita-papa-2026.com', description: 'Privacy policy compliant with GDPR and Spanish LOPDGDD 3/2018. Controller, data, purposes, GDPR rights and contact.' },
    it: { title: 'Privacy policy · visita-papa-2026.com', description: 'Privacy policy conforme al GDPR e alla LOPDGDD 3/2018. Titolare, dati, finalità, diritti GDPR e contatto.' },
    fr: { title: 'Politique de confidentialité · visita-papa-2026.com', description: 'Politique de confidentialité conforme au RGPD et à la LOPDGDD 3/2018. Responsable, données, finalités, droits RGPD.' },
    de: { title: 'Datenschutzerklärung · visita-papa-2026.com', description: 'Datenschutzerklärung konform mit DSGVO und spanischem LOPDGDD 3/2018. Verantwortlicher, Daten, Zwecke, DSGVO-Rechte.' },
    pt: { title: 'Política de privacidade · visita-papa-2026.com', description: 'Política de privacidade conforme o RGPD e LOPDGDD 3/2018. Responsável, dados, finalidades, direitos RGPD e contacto.' },
    ca: { title: 'Política de privacitat · visita-papa-2026.com', description: 'Política de privacitat conforme al RGPD i LOPDGDD 3/2018. Responsable, dades, finalitats, drets RGPD i contacte.' },
    gl: { title: 'Política de privacidade · visita-papa-2026.com', description: 'Política de privacidade conforme ao RGPD e LOPDGDD 3/2018. Responsable, datos, finalidades, dereitos RGPD e contacto.' },
    eu: { title: 'Pribatutasun-politika · visita-papa-2026.com', description: 'Pribatutasun-politika RGPD eta LOPDGDD 3/2018en arabera. Arduraduna, datuak, helburuak, RGPD eskubideak.' },
  },

  'politica-cookies': {
    es: { title: 'Política de cookies · visita-papa-2026.com', description: 'Política de cookies conforme a la Guía AEPD 2023, LSSI-CE art. 22.2 y RGPD. Tabla completa de cookies, finalidades y revocación.' },
    en: { title: 'Cookie policy · visita-papa-2026.com', description: 'Cookie policy compliant with AEPD 2023 Guide, Spanish LSSI-CE art. 22.2 and GDPR. Full cookie table, purposes and consent revocation.' },
    it: { title: 'Cookie policy · visita-papa-2026.com', description: 'Cookie policy conforme alla Guida AEPD 2023, LSSI-CE art. 22.2 e GDPR. Tabella completa cookie, finalità e revoca.' },
    fr: { title: 'Politique de cookies · visita-papa-2026.com', description: 'Politique de cookies conforme au Guide AEPD 2023, LSSI-CE art. 22.2 et RGPD. Tableau complet des cookies et révocation.' },
    de: { title: 'Cookie-Richtlinie · visita-papa-2026.com', description: 'Cookie-Richtlinie gemäß AEPD-Leitfaden 2023, spanischem LSSI-CE Art. 22.2 und DSGVO. Vollständige Cookie-Tabelle.' },
    pt: { title: 'Política de cookies · visita-papa-2026.com', description: 'Política de cookies conforme ao Guia AEPD 2023, LSSI-CE art. 22.2 e RGPD. Tabela completa de cookies e revogação.' },
    ca: { title: 'Política de galetes · visita-papa-2026.com', description: 'Política de galetes conforme a la Guia AEPD 2023, LSSI-CE art. 22.2 i RGPD. Taula completa de galetes i revocació.' },
    gl: { title: 'Política de cookies · visita-papa-2026.com', description: 'Política de cookies conforme á Guía AEPD 2023, LSSI-CE art. 22.2 e RGPD. Táboa completa de cookies e revogación.' },
    eu: { title: 'Cookie-politika · visita-papa-2026.com', description: 'Cookie-politika AEPD 2023 gidarekin, LSSI-CE 22.2 art. eta RGPDrekin bat. Cookie taula osoa eta ezeztapena.' },
  },

  creditos: {
    es: { title: 'Créditos y atribuciones · visita-papa-2026.com', description: 'Atribuciones Creative Commons de imágenes, fuentes oficiales, dependencias open source y licencias. Cumplimiento CC BY-SA 4.0.' },
    en: { title: 'Credits & attributions · visita-papa-2026.com', description: 'Creative Commons image attributions, official sources, open source dependencies and licences used on this site.' },
    it: { title: 'Crediti e attribuzioni · visita-papa-2026.com', description: 'Attribuzioni Creative Commons di immagini, fonti ufficiali, dipendenze open source e licenze utilizzate.' },
    fr: { title: 'Crédits et attributions · visita-papa-2026.com', description: 'Attributions Creative Commons des images, sources officielles, dépendances open source et licences utilisées.' },
    de: { title: 'Credits & Attributionen · visita-papa-2026.com', description: 'Creative-Commons-Bildattributionen, offizielle Quellen, Open-Source-Abhängigkeiten und Lizenzen dieser Website.' },
    pt: { title: 'Créditos e atribuições · visita-papa-2026.com', description: 'Atribuições Creative Commons de imagens, fontes oficiais, dependências open source e licenças utilizadas.' },
    ca: { title: 'Crèdits i atribucions · visita-papa-2026.com', description: 'Atribucions Creative Commons d\'imatges, fonts oficials, dependències open source i llicències utilitzades.' },
    gl: { title: 'Créditos e atribucións · visita-papa-2026.com', description: 'Atribucións Creative Commons de imaxes, fontes oficiais, dependencias open source e licenzas utilizadas.' },
    eu: { title: 'Kredituak eta aitorpenak · visita-papa-2026.com', description: 'Creative Commons irudi-aitorpenak, iturri ofizialak, kode irekiko mendekotasunak eta erabilitako lizentziak.' },
  },
