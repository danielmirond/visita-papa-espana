...
export const metadata: Metadata = {
  title: 'Experiencias de peregrinos en visitas papais anteriores · España',
  ...
  alternates: getAlternates('/experiencias-peregrinos', 'gl'),
}

export default function Page() {
  return <ExperienciasPeregrinosPage locale="gl" />
}
