...
export const metadata: Metadata = {
  title: 'Experiències de pelegrins en visites papals anteriors · Espanya',
  ...
  alternates: getAlternates('/experiencias-peregrinos', 'ca'),
}

export default function Page() {
  return <ExperienciasPeregrinosPage locale="ca" />
}
