...
export const metadata: Metadata = {
  title: 'Magnifica humanitas · primera encíclica Lleó XIV (25 maig 2026)',
  ...
  alternates: getAlternates('/magnifica-humanitas', 'ca'),
}

export default function Page() {
  return <MagnificaHumanitasPage locale="ca" />
}
