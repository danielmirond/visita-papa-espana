...
export const metadata: Metadata = {
  title: 'Experiencias de peregrinos en visitas papales anteriores · España',
  ...
  alternates: getAlternates('/experiencias-peregrinos', 'es'),
}

export default function Page() {
  return <ExperienciasPeregrinosPage locale="es" />
}
