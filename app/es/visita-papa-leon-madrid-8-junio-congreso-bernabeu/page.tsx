...
import { liveblogMadrid8 } from '@/data/liveblog'
import { liveblogSchema } from '@/lib/schema/generators'
import { siteConfig } from '@/data/siteConfig'

const SLUG = 'visita-papa-leon-madrid-8-junio-congreso-bernabeu'

export const metadata: Metadata = {
  title: 'Visita del Papa a Madrid en directo (8 junio): Congreso y Bernabéu',
  description:
    'Sigue en directo el último día del Papa León XIV en Madrid: la reunión con Pedro Sánchez, el discurso ante las Cortes en el Congreso de los Diputados, la oración en la Almudena y el encuentro diocesano en el Santiago Bernabéu. Vídeo y minuto a minuto.',
  alternates: { canonical: `${siteConfig.url}/es/${SLUG}` },
  openGraph: {
    type: 'article',
    url: `${siteConfig.url}/es/${SLUG}`,
    title: 'Visita del Papa a Madrid en directo: Congreso y Bernabéu',
    description: 'Vídeo en directo y minuto a minuto del discurso del Papa en el Congreso y el encuentro en el Bernabéu.',
    images: [{ url: `${siteConfig.url}/images/og/papa-directo-1200x675.jpg`, width: 1200, height: 675, alt: 'Visita del Papa León XIV a Madrid' }],
  },
  twitter: {
...
export default function EnDirectoCongresoBernabeu() {
  const lb = liveblogMadrid8
