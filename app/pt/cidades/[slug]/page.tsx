...
export function generateMetadata({ params }: Props): Metadata {
  ...
  if (!city) return {}
  const localized = getCitiesByLocale("pt").find((c) => c.slug === params.slug)
  ...
  return {
    ...
    alternates: getAlternates(`/ciudades/${params.slug}`, "pt"),
    openGraph: {
...
export default function Page({ params }: Props) {
  return <CiudadDetailPage locale="pt" slug={params.slug} />
}
