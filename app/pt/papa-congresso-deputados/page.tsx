...
export const metadata: Metadata = {
  title: 'Papa Leão XIV no Congresso dos Deputados · 8 jun 2026',
  ...
  alternates: getAlternates('/papa-congreso-diputados', 'pt'),
}

export default function Page() {
  return <PapaCongresoDiputadosPage locale="pt" />
}
