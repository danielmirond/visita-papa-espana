...
export const metadata: Metadata = {
  title: 'Papa Leone XIV al Congresso dei Deputati spagnolo · 8 giu 2026',
  ...
  alternates: getAlternates('/papa-congreso-diputados', 'it'),
}

export default function Page() {
  return <PapaCongresoDiputadosPage locale="it" />
}
