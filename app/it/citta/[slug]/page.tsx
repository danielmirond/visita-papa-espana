...
export function generateMetadata({ params }: Props): Metadata {
  ...
  if (!city) return {}
  const localized = getCitiesByLocale("it").find((c) => c.slug === params.slug)
  ...
  return {
    ...
    alternates: getAlternates(`/ciudades/${params.slug}`, "it"),
    openGraph: {
...
export default function Page({ params }: Props) {
  return <CiudadDetailPage locale="it" slug={params.slug} />
}
