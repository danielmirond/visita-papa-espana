...
export const metadata: Metadata = {
  title: 'Magnifica humanitas · prima enciclica di Leone XIV (25 mag 2026)',
  ...
  alternates: getAlternates('/magnifica-humanitas', 'it'),
}

export default function Page() {
  return <MagnificaHumanitasPage locale="it" />
}
