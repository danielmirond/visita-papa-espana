...
export const metadata: Metadata = {
  title: 'Esperienze dei pellegrini in visite papali precedenti · Spagna',
  ...
  alternates: getAlternates('/experiencias-peregrinos', 'it'),
}

export default function Page() {
  return <ExperienciasPeregrinosPage locale="it" />
}
