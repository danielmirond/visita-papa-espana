...
export const metadata: Metadata = {
  title: 'Magnifica humanitas · Pope Leo XIV first encyclical (25 May 2026)',
  ...
  alternates: getAlternates('/magnifica-humanitas', 'en'),
}

export default function Page() {
  return <MagnificaHumanitasPage locale="en" />
}
