...
export function generateMetadata({ params }: Props): Metadata {
  ...
  if (!city) return {}
  const localized = getCitiesByLocale("en").find((c) => c.slug === params.slug)
  ...
  return {
    ...
    alternates: getAlternates(`/ciudades/${params.slug}`, "en"),
    openGraph: {
...
export default function Page({ params }: Props) {
  return <CiudadDetailPage locale="en" slug={params.slug} />
}
