...
export const metadata: Metadata = {
  title: 'Erromesen esperientziak aurreko bisita papaletan · Espainia',
  ...
  alternates: getAlternates('/experiencias-peregrinos', 'eu'),
}

export default function Page() {
  return <ExperienciasPeregrinosPage locale="eu" />
}
