...
export const metadata: Metadata = {
  title: 'Magnifica humanitas · Leon XIV.aren lehen entzikliko (2026/05/25)',
  ...
  alternates: getAlternates('/magnifica-humanitas', 'eu'),
}

export default function Page() {
  return <MagnificaHumanitasPage locale="eu" />
}
