...
export const metadata: Metadata = {
  title: 'Magnifica humanitas · première encyclique de Léon XIV (25 mai 2026)',
  ...
  alternates: getAlternates('/magnifica-humanitas', 'fr'),
}

export default function Page() {
  return <MagnificaHumanitasPage locale="fr" />
}
