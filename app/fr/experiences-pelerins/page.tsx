...
export const metadata: Metadata = {
  title: 'Expériences des pèlerins en visites papales précédentes · Espagne',
  ...
  alternates: getAlternates('/experiencias-peregrinos', 'fr'),
}

export default function Page() {
  return <ExperienciasPeregrinosPage locale="fr" />
}
